...
class EvalHarnessAdapter(HFLM):
    ...
    def __init__(self, model, forward_step_fn, neox_args, batch_size=None):
        ...
        self.is_pipe_parallel = False # self.model.is_pipe_parallel # TODO
        self.is_data_parallel = False # self.model.is_data_parallel # TODO
        self.is_last_stage = (
    ...
    def run_eval(
        ...
        self.model.eval()
        in_micro_batches = (
            32 # self.model.micro_batches # TODO
