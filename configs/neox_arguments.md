...
- **norm**: typing.Literal['layernorm', 'rmsnorm', 'scalenorm', 'layernorm_nonparam']
...
- **attention_config**: list
    ...
    attention type choices:  [global, local, sparse_fixed, sparse_variable, bslongformer, bigbird, "gmlp", "amlp", "flash", "mamba", "flow"]
