...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    qkv_slot_num: int = None
    proj_slot_num: int = None
    ffn_slot_num: int = None
    """
    Number of slot of attention and ffn block
    """

    qkv_slot_num_new: int = None
    proj_slot_num_new: int = None
    ffn_slot_num_new: int = None
    """
    ...
    norm: Literal["layernorm", "rmsnorm", "scalenorm", "layernorm_nonparam"] = "layernorm"
    """
    Normalization layer to use. Choose from "layernorm", "rmsnorm", "scalenorm", "layernorm_nonparam".
    """

    final_norm: Literal["layernorm", "rmsnorm", "scalenorm", "layernorm_nonparam"] = None
    """
    Normalization of final layer to use. Choose from "layernorm", "rmsnorm", "scalenorm", "layernorm_nonparam".
    """
    ...
    """
    Normalization and activation function for Tokenformer
    """
    norm_activation_type: str = "l2_norm_gelu"
    ...
    attention type choices:  [global, local, sparse_fixed, sparse_variable, bslongformer, bigbird, "gmlp", "amlp", "flash", "mamba", "tokenformer"]
    ...
    # tokenformer
    tokenformer_use: bool = False
    """
    whether uses tokenformer
    """
...
class NeoXArgsTraining(NeoXArgsTemplate):
    ...
    scale_pretrain: str = None
    """
    Path of a pretrained model checkpoint for scaling model.
    """

    load_module_strict: bool = True
    """
    If load checkpoint strictly.
    """

    frozen_old: bool = False
    """
    If frozen the old parameter
    """

    old_lr_decay: bool = False
    old_lr_decay_scale: float = 0.1
    word_embed_fuse: bool = False
    """
    decay learning rate of old parameter and if fuse word embedding (new + old)
    """

    transformer_increase_dim: int = 0
    """
    increase dim for transformer
    """
